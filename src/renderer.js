...
const I18N = {
  ko: {
    ...
    adTitle: '광고 처리',
    adHelp: '유튜브 화면으로 재생할 때 광고·추적 요청을 차단하고, 건너뛸 수 있는 광고는 버튼이 뜨는 즉시 자동으로 넘깁니다. 건너뛰기가 없는 광고는 소리를 끈 채 16배속으로 돌려 빠르게 끝냅니다(30초 광고가 약 4초). 광고가 끝나면 원래 배속과 소리로 돌아옵니다.',
    adOn: '켜기',
    adOff: '끄기',
    adBlocked: '차단한 요청',
  ...
  en: {
    ...
    adTitle: 'Ad handling',
    adHelp: 'Blocks ad and tracking requests on the YouTube view, and presses skip the moment the button appears. An ad with no skip button is run out at 16x with the sound off - a 30-second one takes about four - and your own speed and volume come back when it ends.',
    adOn: 'On',
    adOff: 'Off',
    ...
    agBadge: '18+',
    agBadgeTitle: 'Age-restricted track',
...
const THEMES = {
  ...
  moonlitfamiliar: { name: 'Moonlit Familiar', bg0: '#0a1538', bg1: '#13255f', panel: 'rgba(10,18,49,.88)', panel2: 'rgba(8,14,37,.93)', text: '#fff7c9', muted: '#d7cd90', accent: '#f5e56f', accent2: '#ffb347', good: '#f7ef8b', art: 'assets/moonlit-familiar.png', artOpacity: 0.16, artSize: 'auto 82%', artPosition: 'left center', line: 'rgba(245,229,111,0.28)', emblem: 'assets/emblem-moonlitfamiliar.png', texture: 'stars' },
  ribboncandy: { name: 'Ribbon Candy', light: true, bg0: '#ffeef7', bg1: '#ffdbe9', panel: 'rgba(255,249,252,.90)', panel2: 'rgba(255,242,248,.94)', text: '#7a3e72', muted: '#aa74a3', accent: '#d55ac7', accent2: '#7cc8ff', good: '#ffd36f', art: 'assets/ribbon-candy.png', artOpacity: 0.18, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(213,90,199,0.20)', emblem: 'assets/emblem-ribboncandy.png', texture: 'dots' },
  crayonnight: { name: 'Crayon Pastel Night', bg0: '#131c44', bg1: '#1e2c63', panel: 'rgba(23,33,76,.90)', panel2: 'rgba(15,23,58,.94)', text: '#fdf3c0', muted: '#bfb98d', accent: '#f7dc5c', accent2: '#ff9d5c', good: '#ffe98a', art: 'assets/crayon-night.svg', artOpacity: 0.34, artSize: 'auto 80%', artPosition: 'left center', line: 'rgba(247,220,92,0.30)', emblem: 'assets/emblem-crayonnight.png', texture: 'stars' },
  crayonbloom: { name: 'Crayon Pastel Bloom', light: true, bg0: '#ffeef4', bg1: '#ffdfe9', panel: 'rgba(255,251,253,.92)', panel2: 'rgba(255,244,249,.95)', text: '#69375d', muted: '#9c6a8e', accent: '#f06fa8', accent2: '#7cc3ea', good: '#e8b64c', art: 'assets/crayon-bloom.svg', artOpacity: 0.30, artSize: 'auto 82%', artPosition: 'left center', line: 'rgba(240,111,168,0.24)', emblem: 'assets/emblem-crayonbloom.png', texture: 'paper' },
  crayoncotton: { name: 'Crayon Pastel Cotton', light: true, bg0: '#fdf7ec', bg1: '#f1ecfd', panel: 'rgba(255,253,248,.93)', panel2: 'rgba(250,245,255,.95)', text: '#41406b', muted: '#807ea3', accent: '#8a8fe0', accent2: '#f592b8', good: '#f2c94c', art: 'assets/crayon-cotton.svg', artOpacity: 0.32, artSize: 'auto 82%', artPosition: 'left center', line: 'rgba(138,143,224,0.26)', emblem: 'assets/emblem-crayoncotton.png', texture: 'paper' },
  ...
  dusktape: { name: 'Dusk Tape', bg0: '#050c12', bg1: '#0f2029', panel: 'rgba(13,31,41,.90)', panel2: 'rgba(7,18,25,.94)', text: '#f6e9dc', muted: '#93a6ac', accent: '#f8930f', accent2: '#5fb6c8', good: '#6fd3b8', art: 'assets/dusk-tape.png', artOpacity: 0.20, artSize: 'auto 84%', artPosition: 'left center', line: 'rgba(248,147,15,0.26)', emblem: 'assets/emblem-dusktape.png', texture: 'weave' },
  crtphosphor: { name: 'CRT Phosphor', bg0: '#000000', bg1: '#061009', panel: 'rgba(6,18,10,.92)', panel2: 'rgba(2,8,4,.96)', text: '#8ef0a4', muted: '#4f8f63', accent: '#60d878', accent2: '#b9ffcb', good: '#60d878', art: 'assets/crt-phosphor.png', artOpacity: 0.22, artSize: 'auto 84%', artPosition: 'left center', line: 'rgba(96,216,120,0.30)', emblem: 'assets/emblem-crtphosphor.png', texture: 'scan' },
  risopress: { name: 'Riso Press', light: true, bg0: '#f4f1e6', bg1: '#e9e4d4', panel: 'rgba(252,250,243,.97)', panel2: 'rgba(244,241,230,.98)', text: '#141414', muted: '#5d5a52', accent: '#f03000', accent2: '#2b2926', good: '#3f7a4f', art: 'assets/riso-press.png', artOpacity: 0.16, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(20,20,20,0.34)', emblem: 'assets/emblem-risopress.png', texture: 'paper' },
  neonarcade: { name: 'Neon Arcade', bg0: '#05000f', bg1: '#150141', panel: 'rgba(18,2,54,.88)', panel2: 'rgba(9,0,30,.93)', text: '#f4e9ff', muted: '#9d8ac6', accent: '#ff2fd0', accent2: '#22e7ff', good: '#8cff5a', art: 'assets/neon-arcade.png', artOpacity: 0.26, artSize: 'auto 88%', artPosition: 'left center', line: 'rgba(255,47,208,0.34)', emblem: 'assets/emblem-neonarcade.png', texture: 'scan' },
  sumiink: { name: 'Sumi Ink', light: true, bg0: '#f7f5f0', bg1: '#eeebe3', panel: 'rgba(255,255,255,.95)', panel2: 'rgba(248,246,241,.97)', text: '#141210', muted: '#6b6660', accent: '#2f2c28', accent2: '#b0210f', good: '#4a6b4f', art: 'assets/sumi-ink.png', artOpacity: 0.20, artSize: 'auto 88%', artPosition: 'left center', line: 'rgba(20,18,16,0.22)', emblem: 'assets/emblem-sumiink.png', texture: 'paper' },
  woodblockfall: { name: 'Woodblock Fall', light: true, bg0: '#f6efdd', bg1: '#ead9bd', panel: 'rgba(253,248,236,.96)', panel2: 'rgba(246,238,221,.97)', text: '#3b2a1c', muted: '#7c6650', accent: '#d2622a', accent2: '#7a7f46', good: '#8c7a3f', art: 'assets/woodblock-fall.png', artOpacity: 0.22, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(210,98,42,0.30)', emblem: 'assets/emblem-woodblockfall.png', texture: 'paper' },
  tidepool: { name: 'Tidepool', bg0: '#000305', bg1: '#02121a', panel: 'rgba(2,16,20,.90)', panel2: 'rgba(0,7,10,.95)', text: '#d8fff0', muted: '#6c9a90', accent: '#2ef0a8', accent2: '#9ee34a', good: '#7ef7d8', art: 'assets/tidepool-glow.png', artOpacity: 0.30, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(46,240,168,0.26)', emblem: 'assets/emblem-tidepool.png', texture: 'rings' },
  blueprint: { name: 'Blueprint', light: true, bg0: '#e8eef6', bg1: '#dbe6f2', panel: 'rgba(244,248,253,.82)', panel2: 'rgba(232,240,249,.86)', text: '#0b2c5e', muted: '#5d7ba3', accent: '#0d5bd4', accent2: '#00387c', good: '#0f8a7a', art: 'assets/blueprint.png', artOpacity: 0.26, artSize: 'auto 88%', artPosition: 'left center', line: 'rgba(11,44,94,0.34)', emblem: 'assets/emblem-blueprint.png', texture: 'grid' },
  cassette: { name: 'Cassette Deck', bg0: '#0b0b0c', bg1: '#1c1e20', panel: 'rgba(42,44,47,.96)', panel2: 'rgba(24,26,28,.97)', text: '#e8e6e0', muted: '#9aa3a8', accent: '#f77f00', accent2: '#b8c2c8', good: '#7fd18a', art: 'assets/cassette.png', artOpacity: 0.20, artSize: 'auto 82%', artPosition: 'left center', line: 'rgba(184,194,200,0.24)', emblem: 'assets/emblem-cassette.png', texture: 'weave' },
  stainedglass: { name: 'Stained Glass', bg0: '#04050a', bg1: '#0a1020', panel: 'rgba(9,15,30,.94)', panel2: 'rgba(4,7,15,.96)', text: '#f2ecdf', muted: '#8d93a8', accent: '#1f8fd6', accent2: '#c62134', good: '#2f9e6a', art: 'assets/stained.png', artOpacity: 0.34, artSize: 'auto 90%', artPosition: 'left center', line: 'rgba(31,143,214,0.30)', emblem: 'assets/emblem-stainedglass.png', texture: 'grid' },
  zenma: { name: 'Zen Ma', light: true, bg0: '#f3ece0', bg1: '#e9e0cf', panel: 'rgba(250,246,238,.94)', panel2: 'rgba(243,236,224,.96)', text: '#3a3730', muted: '#8b8677', accent: '#8a8a6e', accent2: '#c4622a', good: '#6f7f5e', art: 'assets/zen-sand.png', artOpacity: 0.24, artSize: 'auto 92%', artPosition: 'left center', line: 'rgba(58,55,48,0.14)', emblem: 'assets/emblem-zenma.png', texture: 'paper' },
  comicpop: { name: 'Comic Pop', light: true, bg0: '#fff8e6', bg1: '#ffeec4', panel: 'rgba(255,255,255,.97)', panel2: 'rgba(255,248,230,.98)', text: '#0a0a0a', muted: '#5a5a5a', accent: '#e01b1b', accent2: '#1652d6', good: '#f5c400', art: 'assets/comic-pop.png', artOpacity: 0.20, artSize: 'auto 88%', artPosition: 'left center', line: 'rgba(10,10,10,0.55)', emblem: 'assets/emblem-comicpop.png', texture: 'dots' },
  aquagel: { name: 'Aqua Gel', light: true, bg0: '#dff4fb', bg1: '#bfe8f6', panel: 'rgba(255,255,255,.70)', panel2: 'rgba(228,247,253,.78)', text: '#093344', muted: '#4b7f95', accent: '#00a6d6', accent2: '#0cd3d3', good: '#22c08a', art: 'assets/aqua-gel.png', artOpacity: 0.26, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(0,166,214,0.26)', emblem: 'assets/emblem-aquagel.png', texture: 'bubble' },
  mochi: { name: 'Mochi Mochi', light: true, bg0: '#f7f1ef', bg1: '#e7dbd8', panel: 'rgba(255,253,252,.95)', panel2: 'rgba(248,241,239,.96)', text: '#4b3a3c', muted: '#907a7c', accent: '#d0778c', accent2: '#7f9c7a', good: '#7fa87c', art: 'assets/mochi.png', artOpacity: 0.18, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(208,119,140,0.20)', mascot: 'assets/mascot-mochi.png', texture: 'paper' },
  boba: { name: 'Brown Sugar Boba', bg0: '#150e0a', bg1: '#2b1c12', panel: 'rgba(50,32,22,.92)', panel2: 'rgba(30,19,13,.95)', text: '#f7e7cf', muted: '#b0947a', accent: '#e0a45c', accent2: '#efdcc0', good: '#9ec27a', art: 'assets/boba.png', artOpacity: 0.14, artSize: 'auto 88%', artPosition: 'left center', line: 'rgba(224,164,92,0.26)', mascot: 'assets/mascot-boba.png', texture: 'bubble' },
  penguin: { name: 'Penguin Cafe', light: true, bg0: '#ecf6f5', bg1: '#d8ecea', panel: 'rgba(255,255,255,.96)', panel2: 'rgba(240,249,248,.97)', text: '#1f2c33', muted: '#63808a', accent: '#ff7a45', accent2: '#2b3a44', good: '#2f9e8a', art: 'assets/penguin.png', artOpacity: 0.20, artSize: 'auto 84%', artPosition: 'left center', line: 'rgba(43,58,68,0.18)', mascot: 'assets/mascot-penguin.png', texture: 'paper' },
  cloudsoda: { name: 'Cloud Soda', light: true, bg0: '#e9f2ff', bg1: '#f7e7f3', panel: 'rgba(255,255,255,.90)', panel2: 'rgba(246,250,255,.94)', text: '#3b4a6b', muted: '#7483aa', accent: '#5b8fe0', accent2: '#e8a92e', good: '#5cbfa6', art: 'assets/cloud-soda.png', artOpacity: 0.24, artSize: 'auto 88%', artPosition: 'left center', line: 'rgba(91,143,224,0.26)', mascot: 'assets/mascot-cloudsoda.png', texture: 'bubble' },
  velvetkuro: { name: 'Velvet Kuro', bg0: '#08060f', bg1: '#181033', panel: 'rgba(26,16,48,.92)', panel2: 'rgba(14,8,28,.95)', text: '#f4e8ff', muted: '#a48fc4', accent: '#ff5fa2', accent2: '#dcb0ff', good: '#8de6c4', art: 'assets/velvet-kuro.png', artOpacity: 0.22, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(255,95,162,0.28)', mascot: 'assets/mascot-velvetkuro.png', texture: 'stars' },
  ...
  astrocat: { name: 'Astro Cat', bg0: '#060a18', bg1: '#111c3a', panel: 'rgba(20,30,58,.90)', panel2: 'rgba(11,18,38,.94)', text: '#e8eeff', muted: '#8f9dc8', accent: '#7ce0c8', accent2: '#ffb38a', good: '#9ad6ff', art: 'assets/astro-cat.png', artOpacity: 0.26, artSize: 'auto 90%', artPosition: 'left center', line: 'rgba(124,224,200,0.26)', mascot: 'assets/mascot-astrocat.png', texture: 'stars' },
  ...
  bakery: { name: 'Bakery', light: true, bg0: '#fdf6e6', bg1: '#f3e3c6', panel: 'rgba(255,252,244,.96)', panel2: 'rgba(250,242,227,.97)', text: '#4d3a24', muted: '#8f7355', accent: '#d9863a', accent2: '#e2557f', good: '#87a552', art: 'assets/bakery.png', artOpacity: 0.18, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(217,134,58,0.26)', mascot: 'assets/mascot-bakery.png', texture: 'dots' },
  turntable: { name: 'Turntable', bg0: '#120d09', bg1: '#251a11', panel: 'rgba(40,28,19,.93)', panel2: 'rgba(24,17,11,.96)', text: '#f0e3d2', muted: '#a48c72', accent: '#e0a13c', accent2: '#c96a3a', good: '#a3b96d', art: 'assets/turntable.png', artOpacity: 0.20, artSize: 'auto 92%', artPosition: 'left center', line: 'rgba(224,161,60,0.28)', emblem: 'assets/emblem-turntable.png', texture: 'rings' },
  terminal: { name: 'Terminal', bg0: '#0b0d10', bg1: '#12161c', panel: 'rgba(15,19,25,.96)', panel2: 'rgba(9,12,16,.97)', text: '#d7dce3', muted: '#69727f', accent: '#7fd88f', accent2: '#e0b341', good: '#7fd88f', line: 'rgba(215,220,227,0.22)', texture: 'grid' },
  metroline: { name: 'Metro Line', light: true, bg0: '#ffffff', bg1: '#eef1f5', panel: 'rgba(255,255,255,.97)', panel2: 'rgba(247,249,252,.98)', text: '#1c2530', muted: '#68737f', accent: '#e8442e', accent2: '#1b62c4', good: '#17a05a', line: 'rgba(28,37,48,0.16)', texture: 'grid' },
  pixelquest: { name: 'Pixel Quest', bg0: '#1a1c2c', bg1: '#262b44', panel: 'rgba(41,47,74,.95)', panel2: 'rgba(28,32,52,.97)', text: '#f4f4f4', muted: '#9aa3bd', accent: '#ffcd75', accent2: '#38b764', good: '#41a6f6', art: 'assets/pixel-quest.png', artOpacity: 0.22, artSize: 'auto 92%', artPosition: 'left center', line: 'rgba(255,205,117,0.28)', mascot: 'assets/mascot-pixelquest.png', texture: 'pixel' },
  hologram: { name: 'Hologram', bg0: '#03060c', bg1: '#06121c', panel: 'rgba(8,22,34,.84)', panel2: 'rgba(4,12,20,.90)', text: '#dff6ff', muted: '#6fa3b8', accent: '#35e6ff', accent2: '#ff5fd0', good: '#7cffcf', art: 'assets/hologram.png', artOpacity: 0.40, artSize: 'auto 96%', artPosition: 'left center', line: 'rgba(53,230,255,0.30)', mascot: 'assets/mascot-hologram.png', texture: 'scan' },
  newsprint: { name: 'Newsprint', light: true, bg0: '#f7f4ec', bg1: '#e9e4d6', panel: 'rgba(252,250,244,.97)', panel2: 'rgba(244,241,232,.98)', text: '#16140f', muted: '#5c5749', accent: '#b3231f', accent2: '#16140f', good: '#3f6b3a', line: 'rgba(22,20,15,0.30)', texture: 'dots' },
...
function applyStaticTheme(theme) {
  ...
  // The deck panel gets its own artwork rather than a crop of the gallery
  // illustration. Those are tall scenes drawn to fill a portrait card, and
  // the panel is a wide short strip: every crop of one sat wrong in the
  // other. An emblem is a single motif cut out to transparency, so it has no
  // aspect ratio to mismatch, no rectangle to show an edge and nothing to
  // crop - it just scales to whatever room there is.
  root.style.setProperty('--theme-emblem', theme.emblem ? 'url("' + theme.emblem + '")' : 'none');
  document.body.classList.toggle('has-emblem', !!theme.emblem);
  ...
  document.body.dataset.texture = theme.texture || 'none';
  // The stencil is filled with the theme's own muted colour, so the motif is
  // always a member of the palette rather than a guest in it.
  root.style.setProperty('--theme-motif-ink', theme.motifInk || 'var(--muted)');
  // A light theme carries dark ink at a fraction of the weight a dark theme
  // carries light ink; these are the two numbers that keep them level.
  root.style.setProperty('--theme-texture-opacity', String(theme.textureOpacity ?? (theme.light ? 0.7 : 1)));
  root.style.setProperty('--theme-emblem-opacity', String(theme.emblemOpacity ?? (theme.light ? 0.20 : 0.30)));
  root.style.setProperty('--theme-watermark-opacity', String(theme.watermarkOpacity ?? (theme.light ? 0.11 : 0.17)));
  ...
  (function ensureThemeLayers() {
    ...
    const chips = document.querySelector('.chip-panel');
    const add = (host, cls, first) => {
      if (!host || host.querySelector(':scope > .' + cls)) return;
      const el = document.createElement('div');
      el.className = cls;
      el.setAttribute('aria-hidden', 'true');
      if (first) host.prepend(el); else host.appendChild(el);
    };
    // The texture repeats, so it fills a 1425x190 strip and a 356x389 column
    // equally well. That is the whole point of it being a pattern and not a
    // picture: it has no aspect ratio of its own to fit.
    add(panel, 'theme-texture', true);
    add(chips, 'theme-texture', true);
    add(panel, 'theme-emblem', true);
    add(chips, 'theme-watermark', true);
    const row = panel && panel.querySelector('.track-row');
...
function playOrPause() {
  leaveBrowserMode();
  if (ytMode) { ytSendCommand('toggle'); return; }
  if (!ready) return;
...
function wireEvents() {
  ...
  els.volumeSlider.addEventListener('input', () => {
    ...
    if (ytMode) ytSendCommand('volume', state.playback.volume);
    saveState();
  });
