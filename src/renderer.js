...
const THEMES = {
  ...
  moonlitfamiliar: { name: 'Moonlit Familiar', bg0: '#0a1538', bg1: '#13255f', panel: 'rgba(10,18,49,.88)', panel2: 'rgba(8,14,37,.93)', text: '#fff7c9', muted: '#d7cd90', accent: '#f5e56f', accent2: '#ffb347', good: '#f7ef8b', art: 'assets/moonlit-familiar.png', artOpacity: 0.16, artSize: 'auto 82%', artPosition: 'left center', line: 'rgba(245,229,111,0.28)', emblem: 'assets/emblem-moonlitfamiliar.png' },
  ribboncandy: { name: 'Ribbon Candy', light: true, bg0: '#ffeef7', bg1: '#ffdbe9', panel: 'rgba(255,249,252,.90)', panel2: 'rgba(255,242,248,.94)', text: '#7a3e72', muted: '#aa74a3', accent: '#d55ac7', accent2: '#7cc8ff', good: '#ffd36f', art: 'assets/ribbon-candy.png', artOpacity: 0.18, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(213,90,199,0.20)', emblem: 'assets/emblem-ribboncandy.png' },
  crayonnight: { name: 'Crayon Pastel Night', bg0: '#131c44', bg1: '#1e2c63', panel: 'rgba(23,33,76,.90)', panel2: 'rgba(15,23,58,.94)', text: '#fdf3c0', muted: '#bfb98d', accent: '#f7dc5c', accent2: '#ff9d5c', good: '#ffe98a', art: 'assets/crayon-night.svg', artOpacity: 0.34, artSize: 'auto 80%', artPosition: 'left center', line: 'rgba(247,220,92,0.30)', emblem: 'assets/emblem-crayonnight.png' },
  crayonbloom: { name: 'Crayon Pastel Bloom', light: true, bg0: '#ffeef4', bg1: '#ffdfe9', panel: 'rgba(255,251,253,.92)', panel2: 'rgba(255,244,249,.95)', text: '#69375d', muted: '#9c6a8e', accent: '#f06fa8', accent2: '#7cc3ea', good: '#e8b64c', art: 'assets/crayon-bloom.svg', artOpacity: 0.30, artSize: 'auto 82%', artPosition: 'left center', line: 'rgba(240,111,168,0.24)', emblem: 'assets/emblem-crayonbloom.png' },
  crayoncotton: { name: 'Crayon Pastel Cotton', light: true, bg0: '#fdf7ec', bg1: '#f1ecfd', panel: 'rgba(255,253,248,.93)', panel2: 'rgba(250,245,255,.95)', text: '#41406b', muted: '#807ea3', accent: '#8a8fe0', accent2: '#f592b8', good: '#f2c94c', art: 'assets/crayon-cotton.svg', artOpacity: 0.32, artSize: 'auto 82%', artPosition: 'left center', line: 'rgba(138,143,224,0.26)', emblem: 'assets/emblem-crayoncotton.png' },
  ...
  dusktape: { name: 'Dusk Tape', bg0: '#050c12', bg1: '#0f2029', panel: 'rgba(13,31,41,.90)', panel2: 'rgba(7,18,25,.94)', text: '#f6e9dc', muted: '#93a6ac', accent: '#f8930f', accent2: '#5fb6c8', good: '#6fd3b8', art: 'assets/dusk-tape.png', artOpacity: 0.20, artSize: 'auto 84%', artPosition: 'left center', line: 'rgba(248,147,15,0.26)', emblem: 'assets/emblem-dusktape.png' },
  crtphosphor: { name: 'CRT Phosphor', bg0: '#000000', bg1: '#061009', panel: 'rgba(6,18,10,.92)', panel2: 'rgba(2,8,4,.96)', text: '#8ef0a4', muted: '#4f8f63', accent: '#60d878', accent2: '#b9ffcb', good: '#60d878', art: 'assets/crt-phosphor.png', artOpacity: 0.22, artSize: 'auto 84%', artPosition: 'left center', line: 'rgba(96,216,120,0.30)', emblem: 'assets/emblem-crtphosphor.png' },
  ...
  neonarcade: { name: 'Neon Arcade', bg0: '#05000f', bg1: '#150141', panel: 'rgba(18,2,54,.88)', panel2: 'rgba(9,0,30,.93)', text: '#f4e9ff', muted: '#9d8ac6', accent: '#ff2fd0', accent2: '#22e7ff', good: '#8cff5a', art: 'assets/neon-arcade.png', artOpacity: 0.26, artSize: 'auto 88%', artPosition: 'left center', line: 'rgba(255,47,208,0.34)', emblem: 'assets/emblem-neonarcade.png' },
  sumiink: { name: 'Sumi Ink', light: true, bg0: '#f7f5f0', bg1: '#eeebe3', panel: 'rgba(255,255,255,.95)', panel2: 'rgba(248,246,241,.97)', text: '#141210', muted: '#6b6660', accent: '#2f2c28', accent2: '#b0210f', good: '#4a6b4f', art: 'assets/sumi-ink.png', artOpacity: 0.20, artSize: 'auto 88%', artPosition: 'left center', line: 'rgba(20,18,16,0.22)', emblem: 'assets/emblem-sumiink.png' },
  ...
  tidepool: { name: 'Tidepool', bg0: '#000305', bg1: '#02121a', panel: 'rgba(2,16,20,.90)', panel2: 'rgba(0,7,10,.95)', text: '#d8fff0', muted: '#6c9a90', accent: '#2ef0a8', accent2: '#9ee34a', good: '#7ef7d8', art: 'assets/tidepool-glow.png', artOpacity: 0.30, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(46,240,168,0.26)', emblem: 'assets/emblem-tidepool.png' },
  blueprint: { name: 'Blueprint', light: true, bg0: '#e8eef6', bg1: '#dbe6f2', panel: 'rgba(244,248,253,.82)', panel2: 'rgba(232,240,249,.86)', text: '#0b2c5e', muted: '#5d7ba3', accent: '#0d5bd4', accent2: '#00387c', good: '#0f8a7a', art: 'assets/blueprint.png', artOpacity: 0.26, artSize: 'auto 88%', artPosition: 'left center', line: 'rgba(11,44,94,0.34)', emblem: 'assets/emblem-blueprint.png' },
  cassette: { name: 'Cassette Deck', bg0: '#0b0b0c', bg1: '#1c1e20', panel: 'rgba(42,44,47,.96)', panel2: 'rgba(24,26,28,.97)', text: '#e8e6e0', muted: '#9aa3a8', accent: '#f77f00', accent2: '#b8c2c8', good: '#7fd18a', art: 'assets/cassette.png', artOpacity: 0.20, artSize: 'auto 82%', artPosition: 'left center', line: 'rgba(184,194,200,0.24)', emblem: 'assets/emblem-cassette.png' },
  stainedglass: { name: 'Stained Glass', bg0: '#04050a', bg1: '#0a1020', panel: 'rgba(9,15,30,.94)', panel2: 'rgba(4,7,15,.96)', text: '#f2ecdf', muted: '#8d93a8', accent: '#1f8fd6', accent2: '#c62134', good: '#2f9e6a', art: 'assets/stained.png', artOpacity: 0.34, artSize: 'auto 90%', artPosition: 'left center', line: 'rgba(31,143,214,0.30)', emblem: 'assets/emblem-stainedglass.png' },
  zenma: { name: 'Zen Ma', light: true, bg0: '#f3ece0', bg1: '#e9e0cf', panel: 'rgba(250,246,238,.94)', panel2: 'rgba(243,236,224,.96)', text: '#3a3730', muted: '#8b8677', accent: '#8a8a6e', accent2: '#c4622a', good: '#6f7f5e', art: 'assets/zen-sand.png', artOpacity: 0.24, artSize: 'auto 92%', artPosition: 'left center', line: 'rgba(58,55,48,0.14)', emblem: 'assets/emblem-zenma.png' },
  ...
  aquagel: { name: 'Aqua Gel', light: true, bg0: '#dff4fb', bg1: '#bfe8f6', panel: 'rgba(255,255,255,.70)', panel2: 'rgba(228,247,253,.78)', text: '#093344', muted: '#4b7f95', accent: '#00a6d6', accent2: '#0cd3d3', good: '#22c08a', art: 'assets/aqua-gel.png', artOpacity: 0.26, artSize: 'auto 86%', artPosition: 'left center', line: 'rgba(0,166,214,0.26)', emblem: 'assets/emblem-aquagel.png' },
...
function applyStaticTheme(theme) {
  ...
  (function ensureThemeLayers() {
    ...
    if (!panel) return;
    if (!panel.querySelector(':scope > .theme-emblem')) {
      const emblem = document.createElement('div');
      emblem.className = 'theme-emblem';
